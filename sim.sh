...
ghdl -c --std=08 global_package.vhd stc_pkt_handler_package.vhd  bcc_stm_iface.vhd sync_fifo_iface.vhd\
 sync_fifo.vhd g1g_pstc_packet_handlinge.vhd g1g_stc_mem_interfacer.vhd  payload_handler.vhd bcc_stm_generation.vhd\
 glg_stc_stm_top.vhd
